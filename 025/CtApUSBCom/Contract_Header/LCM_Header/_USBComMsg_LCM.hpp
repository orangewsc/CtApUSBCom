...
class _USBComMsg_LCM
{
    public:
        ...
        uint8_t    ParkingSpaceDsp_TgtParkngSpaceID_RTE_Recv;

        uint8_t    ParkingSpaceDsp_TgtParkngSpaceID_SOCK_Send;

        uint8_t    ParkingSpaceDsp_TgtParkingChosed_SOCK_Recv;

        uint8_t    ParkingSpaceDsp_TgtParkingChosed_RTE_Send;
...
int _USBComMsg_LCM::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    ...
    tlen = __byte_encode_array(buf, offset + pos, maxlen - pos, &this->ParkingSpaceDsp_TgtParkngSpaceID_RTE_Recv, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __byte_encode_array(buf, offset + pos, maxlen - pos, &this->ParkingSpaceDsp_TgtParkngSpaceID_SOCK_Send, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __byte_encode_array(buf, offset + pos, maxlen - pos, &this->ParkingSpaceDsp_TgtParkingChosed_SOCK_Recv, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __byte_encode_array(buf, offset + pos, maxlen - pos, &this->ParkingSpaceDsp_TgtParkingChosed_RTE_Send, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
int _USBComMsg_LCM::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    ...
    tlen = __byte_decode_array(buf, offset + pos, maxlen - pos, &this->ParkingSpaceDsp_TgtParkngSpaceID_RTE_Recv, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __byte_decode_array(buf, offset + pos, maxlen - pos, &this->ParkingSpaceDsp_TgtParkngSpaceID_SOCK_Send, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __byte_decode_array(buf, offset + pos, maxlen - pos, &this->ParkingSpaceDsp_TgtParkingChosed_SOCK_Recv, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __byte_decode_array(buf, offset + pos, maxlen - pos, &this->ParkingSpaceDsp_TgtParkingChosed_RTE_Send, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
uint64_t _USBComMsg_LCM::_computeHash(const __lcm_hash_ptr *p)
{
    ...
    uint64_t hash = 0xa0f1a4f84a78a0c1LL +
