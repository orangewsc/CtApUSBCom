...
void USBSpeedControl::Start_SendMsg()
{
	...
	if (g_USBCom_LCM_DEBUG == 1)
	{
		...
		USBComMsgLCM.SpeedControl_IECU2FICM_RTE_Recv.IECUTimeStamp 	 =  (int64_t)(IECUTimestampRte.DeTimestampHigh << 32) | 
		...
		m_flag_reconnect == 1)
	{
		...
		else
		{
			...
			if (g_USBCom_LCM_DEBUG == 1)
			{
				ClockSourceRte = 1;
				Rte_Call_CtApUSBCom_PpPFServer_TS_GetEgtTimestamp(&IECUTimestampRte, &ClockSourceRte);
				USBComMsgLCM.SpeedControl_IECU2FICM_SOCK_Send.IECUTimeStamp 	= (int64_t)(IECUTimestampRte.DeTimestampHigh << 32) | 
																				  (int64_t)IECUTimestampRte.DeTimestampLow;
...
void USBSpeedControl::Rte_Write()
{
	...
	{	
		ClockSourceRte = 1;
		Rte_Call_CtApUSBCom_PpPFServer_TS_GetEgtTimestamp(&IECUTimestampRte, &ClockSourceRte);
		USBComMsgLCM.SpeedControl_FICM2IECU_SOCK_Recv.IECUTimeStamp 	= (int64_t)(IECUTimestampRte.DeTimestampHigh << 32) | 
																		  (int64_t)IECUTimestampRte.DeTimestampLow;
		...
		USBComMsgLCM.SpeedControl_FICM2IECU_RTE_Send.IECUTimeStamp		= (int64_t)(IECUTimestampRte.DeTimestampHigh << 32) | 
																		  (int64_t)IECUTimestampRte.DeTimestampLow;
