...
//-----------------Print-----------------Print-----------------Print-----------------Print-----------------Print
	...
	if (g_USBCom_LCM_DEBUG == 1)
	{
		...
		USBComMsgLCM.AIPilotObj_RTE_Recv.IECUTimeStamp = (int64_t)(IECUTimestampRte.DeTimestampHigh << 32) | (int64_t)IECUTimestampRte.DeTimestampLow;
		for (uint8_t i = 0; i < 15; i++)
		{
			USBComMsgLCM.AIPilotObj_RTE_Recv.AIPilotObj[i].AIPilotObjId 			= m_AIPilotObjDsp_RTE.gstAIPilotObjects[i].PaddingGap16_2;
		...
		USBComMsgLCM.AIPilotObj_RTE_Recv.FollowCarID 			= m_AIPilotObjDsp_RTE.gstAIPilotObjects[15].PaddingGap16_2;
...
//-----------------Print-----------------Print-----------------Print-----------------Print-----------------Print
	m_AIPilotObjDsp_Socket_SP.IECUTimeStamp = (uint64_t)(m_AIPilotObjDsp_RTE.stHeader.TimeStamp[1] << 32) | (uint64_t)m_AIPilotObjDsp_RTE.stHeader.TimeStamp[0];
	for (uint8_t i = 0; i < 15; i++)
	{
		m_AIPilotObjDsp_Socket_SP.AIPilotObj_Socket[i].AIPilotObjId 			= m_AIPilotObjDsp_RTE.gstAIPilotObjects[i].PaddingGap16_2;
	...
	m_AIPilotObjDsp_Socket_SP.FollowCarID 			= m_AIPilotObjDsp_RTE.gstAIPilotObjects[15].PaddingGap16_2;
...
//-----------------Print-----------------Print-----------------Print-----------------Print-----------------Print
		...
		if (g_USBCom_LCM_DEBUG == 1)
		{
			ClockSourceRte = 1;
			Rte_Call_CtApUSBCom_PpPFServer_TS_GetEgtTimestamp(&IECUTimestampRte, &ClockSourceRte);
			USBComMsgLCM.AIPilotObj_SOCK_Send.IECUTimeStamp = (int64_t)(IECUTimestampRte.DeTimestampHigh << 32) | 
...
void USBAIPilotObjDsp::Print_Sock_Send()
{
	ClockSourceRte = 1;
	Rte_Call_CtApUSBCom_PpPFServer_TS_GetEgtTimestamp(&IECUTimestampRte, &ClockSourceRte);
	uint64_t IECUTime_USBCom = (uint64_t)(IECUTimestampRte.DeTimestampHigh << 32) | (uint64_t)IECUTimestampRte.DeTimestampLow;
