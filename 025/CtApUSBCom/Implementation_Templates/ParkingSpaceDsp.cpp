...
//-----------------Print-----------------Print-----------------Print-----------------Print-----------------Print
	...
	if (g_USBCom_LCM_DEBUG == 1)
	{
		for (uint8_t i = 0; i < 8; i++)
		{
			...
			USBComMsgLCM.ParkingSpace_RTE_Recv[i].IECUTimeStamp 			= (int64_t)(IECUTimestampRte.DeTimestampHigh << 32) | 
		...
		USBComMsgLCM.ParkingSpaceDsp_TgtParkngSpaceID_RTE_Recv = m_ParkingSpaceDsp_RTE.TgtParkngSpaceID;
	}
//-----------------Print-----------------Print-----------------Print-----------------Print-----------------Print
	m_ParkingSpaceDsp_Socket_SP.IECUTimeStamp = (uint64_t)(m_ParkingSpaceDsp_RTE.stHeader.TimeStamp[1] << 32) | 
...
//-----------------Print-----------------Print-----------------Print-----------------Print-----------------Print
		...
		if (g_USBCom_LCM_DEBUG == 1)
		{
			for (uint8_t i = 0; i < 8; i++)
			{
				ClockSourceRte = 1;
				Rte_Call_CtApUSBCom_PpPFServer_TS_GetEgtTimestamp(&IECUTimestampRte, &ClockSourceRte);
				USBComMsgLCM.ParkingSpace_SOCK_Send[i].IECUTimeStamp 			= (int64_t)(IECUTimestampRte.DeTimestampHigh << 32) | 
																				  (int64_t)IECUTimestampRte.DeTimestampLow;
			...
			USBComMsgLCM.ParkingSpaceDsp_TgtParkngSpaceID_SOCK_Send = m_ParkingSpaceDsp_Socket_SP.TgtParkngSpaceID;
		}
//-----------------Print-----------------Print-----------------Print-----------------Print-----------------Print
	}
}
...
//-----------------Print-----------------Print-----------------Print-----------------Print-----------------Print
	...
	if (g_USBCom_LCM_DEBUG == 1)
	{	
		USBComMsgLCM.ParkingSpaceDsp_TgtParkingChosed_SOCK_Recv = m_ParkingSpaceDsp_Socket_RP.TgtParkingChosed;
		USBComMsgLCM.ParkingSpaceDsp_TgtParkingChosed_RTE_Send 	= m_ParkngSpaceDspFeedBack_RTE.FeedBack;
	}
//-----------------Print-----------------Print-----------------Print-----------------Print-----------------Print
}
